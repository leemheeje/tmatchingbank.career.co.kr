...
<head>
    ...
    <link rel="stylesheet" href="/mobile/css/common.css?<%=publishUpdateDt%>">
    <link rel="stylesheet" href="/mobile/css/layout.css?<%=publishUpdateDt%>">
    <link rel="stylesheet" href="/mobile/css/main.css?<%=publishUpdateDt%>"><!-- main에서만 사용 -->
    <link rel="stylesheet" href="/mobile/css/contents.css?<%=publishUpdateDt%>">
    <link rel="stylesheet" href="/mobile/css/user.css?<%=publishUpdateDt%>">  <!-- 개인회원 CSS -->
    <!-- STYLE:E -->

	<!-- Javascript:S -->
    <script type="text/javascript" src="/mobile/js/libs/jquery-3.5.1.min.js?<%=publishUpdateDt%>"></script>
    <script type="text/javascript" src="/mobile/js/libs/library.js?<%=publishUpdateDt%>"></script>
    <script type="text/javascript" src="/mobile/js/ui/layout.js?<%=publishUpdateDt%>"></script>
    <script type="text/javascript" src="/js/ui/design.utils.js?<%=publishUpdateDt%>"></script>
    <script type="text/javascript" src="/js/ui/design.plugin.js?<%=publishUpdateDt%>"></script>

	<script type="text/javascript" src="/js/comm.js?<%=publishUpdateDt%>"></script>
	<script type="text/javascript" src="/wwwconf/js/comm_validate.js?<%=publishUpdateDt%>"></script>
	<script type="text/javascript" src="/wwwconf/js/comm_function.js?<%=publishUpdateDt%>"></script>
	<!-- Javascript:E -->


    <!-- Global site tag (gtag.js) - Google Analytics -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-211783953-2"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());

      gtag('config', 'UA-211783953-2');
    </script>
