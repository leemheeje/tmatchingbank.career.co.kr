 ...
 */
	...
	this.init_naver_id_login_function = function ()
	{
		naver_id_login_url = this.getNaverIdLoginLink();
//		naver_id_login_contents = "<a href='"+naver_id_login_url+"' id='nvLoginUrl'>naver_id_login_url</a> ";
		naver_id_login_contents = "<input type='hidden' value='"+naver_id_login_url+"' id='nvLoginUrl'/>";
		naver_id_login_test.innerHTML = naver_id_login_contents;
